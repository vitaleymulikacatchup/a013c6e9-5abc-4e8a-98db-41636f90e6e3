...
export const metadata: Metadata = {
  title: "CarHub - Premium Car Dealership | Luxury Vehicles & Financing",
  description: "Find your dream car at CarHub. Browse luxury vehicles from BMW, Mercedes, Porsche & more. Professional service, competitive prices & financing available.",
  keywords: "car dealership, luxury cars, BMW, Mercedes, Porsche, Tesla, car financing, vehicle inspection, premium automobiles",
  metadataBase: new URL("https://carhub.com"),
  alternates: {
    canonical: "https://carhub.com"
  },
  openGraph: {
    title: "CarHub - Premium Car Dealership",
    description: "Browse our extensive collection of premium vehicles from trusted brands with professional service and competitive financing.",
    siteName: "CarHub",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/7144181/pexels-photo-7144181.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "CarHub luxury car showroom"
      }
    ]
  },
  twitter: {
    ...
    title: "CarHub - Premium Car Dealership",
    description: "Find your dream car with professional service and competitive financing options.",
    images: ["https://images.pexels.com/photos/7144181/pexels-photo-7144181.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
